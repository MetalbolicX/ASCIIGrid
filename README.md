...
<div align="center">
  <img src="./images/logo.png" alt="ASCIIGrid Logo" width="200" height="200" />
</div>

> `ASCIIGrid` small slogan.
...
```json
{
  "bs-dependencies": ["ASCIIGrid"]
}
```

## 🙌 Hello World Example

Here's a simple example of how to use `ASCIIGrid` to create a reactive UI component:
...
To build and run your ReScript application, see the [Compile and Run](https://metalbolicx.github.io/ASCIIGrid/#/compile-run) section.

## 📚 Documentation

<div align="center">

  [![view - Documentation](https://img.shields.io/badge/view-Documentation-blue?style=for-the-badge)](https://metalbolicx.github.io/ASCIIGrid/#/api-reference)
